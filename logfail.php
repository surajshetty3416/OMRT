...
<div class="container">
  ...
  <article class="content">
    ...
    <section>
      ...
      <h3><span id="fromop">Username :
          <label for="userid"></label>
        <input name="userid" type="text" id="userid" value="">
        <span class="selectRequiredMsg"></span></span></h3>
      <h3>Password:
        <label for="password"></label>
        <input name="password" type="password" id="password" value="">
        </h3>
        <input type="text" name="fromop" id="fromop" value=" <?php echo $_SESSION['MM_fromop']; ?>">
      <input type= "text" name="toop" id="toop" value=" <?php echo $_SESSION['MM_toop']; ?>">
      <input type="text" name="fare" id="fare" value=" <?php echo $_SESSION['MM_fare']; ?>">
      <p><font color="#FF0000" size="-1">Wrong username or password ....please try again.</font></p>
      <p>&nbsp;</p>
    <p align="center">
